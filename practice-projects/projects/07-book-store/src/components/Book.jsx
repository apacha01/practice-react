function Book({ title, author, cover, year, onClick, reading = false }) {
	return (
		<div className="bg-white border-[1px] border-gray-400 rounded-xl overflow-hidden shadow-xl hover:scale-105 hover:shadow-2xl transform duration-500">
			<div className="p-4">
			...
			<div className="relative">
				<img className="w-80 m-auto" src={cover} />
				{
					reading
